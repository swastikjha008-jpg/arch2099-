...
export const DEFAULT_EFFECT_OPTIONS: any = {
  onSpeedUp: () => {},
  onSlowDown: () => {},
  ...
  useEffect(() => {
    ...
    class App {
      ...
      constructor(container: HTMLDivElement, options: any = {}) {
        ...
        if (this.options.distortion == null) {
          this.options.distortion = { uniforms: turbulentUniforms, getDistortion: '' };
        }
    ...
    class CarLights {
      ...
      init() {
        ...
        let geometry = new THREE.TubeGeometry(curve as any, 40, 1, 8, false);
        ...
        colors = Array.isArray(colors) ? colors.map((c: any) => new THREE.Color(c)) : new THREE.Color(colors);
